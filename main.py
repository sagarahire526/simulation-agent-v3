...
#     n.kpi_source_columns = ['stg_ndpd_hse_site_checklist.smp_id', 'stg_ndpd_hse_site_checklist.smp_name', 'stg_ndpd_hse_site_checklist.gsd_hse_review_check_date', 'stg_ndpd_hse_site_checklist.check_in_status', 'stg_ndpd_hse_site_checklist.ppe_validation', 'stg_ndpd_hse_site_checklist.jsa_completion_status', 'stg_ndpd_hse_site_checklist.each_crew_ptid_l2w_status', 'stg_ndpd_hse_site_checklist.non_compliance_status', 'stg_ndpd_hse_site_checklist.customer_name', 'stg_ndpd_hse_site_checklist.hse_status', 'stg_ndpd_hse_site_checklist.hse_engineer_name', 'stg_ndpd_mbt_tmobile_macro_combined.smp_id', 'stg_ndpd_mbt_tmobile_macro_combined.rgn_region', 'stg_ndpd_mbt_tmobile_macro_combined.m_area', 'stg_ndpd_mbt_tmobile_macro_combined.m_market', 'stg_ndpd_mbt_tmobile_macro_combined.construction_gc']
